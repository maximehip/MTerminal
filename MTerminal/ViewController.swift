...
//  MTerminal
//
//  Created by Maximehip on 18/12/16.
//  Copyright © 2016 Maximehip. All rights reserved.
//
...
class ViewController: UIViewController {
    ...
    override func viewDidAppear(_ animated: Bool) {
        ...
        // welcome message
        console.log("MTerminal by maximehip")
        
        // disable spell checking (messes up some commands)
        console.autocorrectionType = UITextAutocorrectionType.no;
        
        var alert = UIAlertController(title: "MTerminal", message: "Enter hostname and port to connect. Leave blank and press OK for defaults.", preferredStyle: UIAlertControllerStyle.alert)
        //
